-- ============================================================================
-- UNIFIED AUTHENTICATION SYSTEM MIGRATION (FIXED)
-- Migrates from dual auth to single Supabase Auth
-- Fixed: Creates private schema if it doesn't exist
-- ============================================================================
...
-- 3. Migrate existing admin users (check if table exists first)
DO $$
BEGIN
  IF EXISTS (
...
-- First, check if organization_id can be null and update if needed
DO $$
BEGIN
  -- Update any NULL organization_ids with first council
