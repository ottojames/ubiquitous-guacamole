...
### [ ] US-0011: Fix Wizard Step4 Upload
...
**Evidence:** BROWSER TESTED: Changed upload default to always 'template' (src/next/publish/flow/steps/UploadMethodStep.tsx:55), removed unnecessary fields from applicantSection (src/next/publish/config/formBlueprints.ts:160-181), added Sampletonborough Council (scripts/add-sampletonborough-council.ts), navigated to wizard step 2 with premises-licence, verified template is default upload method, unnecessary fields (trading name, company number, DPS) removed, Sampletonborough Council selectable, sale of alcohol at top of activities list.
...
### [ ] US-0026: Remove Demo Logins Firm
...
### [ ] US-0027: Implement Safe Demo Access
...
### [ ] US-0028: Fix Publish Wizard Submit
...
### [ ] US-0029: Add Submit Error Handling
...
### [ ] US-0120: Blue Notice Display Instructions
