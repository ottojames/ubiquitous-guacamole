...
### [x] US-0001: Fix Public Notice Detail Page
...
### [x] US-0002: Fix Council Notice Retrieval
...
### [x] US-0003: Fix Council Representations Loading
...
### [x] US-0004: Fix Council Analytics Loading
...
### [x] US-0005: Fix Firm Payment Button
...
### [x] US-0006: Fix Firm View Client Notices
...
### [x] US-0007: Implement Firm Notices Page
...
### [x] US-0008: Implement Firm Billing Page
...
### [x] US-0009: Fix Firm Team Page Loading
...
### [x] US-0010: Fix Firm Settings Notice Filter
...
### [x] US-0011: Fix Wizard Step4 Upload
...
### [x] US-0012: Improve Department Switching Ux
...
### [x] US-0013: Research Department Dashboards
...
-   - Research environmental health department needs
...
### [x] US-0014: Verify Templates Work With Matching
...
### [x] US-0026: Remove Demo Logins Firm
...
### [x] US-0027: Implement Safe Demo Access
...
### [x] US-0028: Fix Publish Wizard Submit
...
### [x] US-0029: Add Submit Error Handling
...
### [x] US-0108: One Click Address Select
...
### [x] US-0109: Radius Filters Before Search
...
### [x] US-0117: Generate Blue Notice Pdf
...
### [x] US-0118: Blue Notice Templates
...
### [x] US-0120: Blue Notice Display Instructions
...
### [x] US-0125: Licensing Dashboard Widgets
...
### [x] US-0126: Assign Representation To Officer
...
### [x] US-0127: Mark Representation Reviewed
...
### [x] US-0128: Internal Notes On Representations
...
### [x] US-0129: Export Reps For Idox
...
## CRITICAL FIXES REQUIRED (From Testing Feedback 2026-01-15)

### [x] FIX-001: Fix Demo Authentication for Council and Firm Portals
...
### [x] FIX-002: Fix Address Search Double-Click Issue and Default to Map View
...
### [x] FIX-003: Redesign Map View with 70/30 Split Layout
...
### [x] FIX-004: Remove Unnecessary Fields from Publish Wizard
...
### [ ] FIX-011: Redesign Registration as Questionnaire Wizard
