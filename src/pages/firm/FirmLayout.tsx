...
export default function FirmLayout() {
  ...
  const navItems = [
    ...
    { path: 'submissions', label: 'My Submissions', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    { path: 'new-submission', label: 'New Submission', icon: 'M12 4v16m8-8H4' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-pink-50">
      ...
      >
        <div className="p-6">
          <Outlet context={{ organization, userRole }} />
        </div>
      </main>
    </div>
  );
