...
const segments: SegmentCard[] = [
  {
    ...
    description: 'Watch how residents discover and respond to local licensing applications in their area.',
  ...
  },
  {
    ...
    description: 'See how solicitors publish statutory notices with 82% cost savings and instant validation.',
  ...
  },
  {
    ...
    description: 'Explore the licensing officer workflow for managing applications and representations.',
  ...
  },
  {
    ...
    description: 'Discover how senior management gains strategic insights and demonstrates accountability.',
