...
export default function GamblingForm({ onSubmit, saving, autoFocusRef }: Props) {
  ...
  return (
    <form onSubmit={submit} className="mt-6 space-y-4" aria-describedby="gambling-desc">
      <p id="gambling-desc" className="sr-only">Gambling licence placeholder form</p>
      <div>
